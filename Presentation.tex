...
\]
	...
	\section{Experimental results}
		...
		\centering{Artificial graph:}
			\begin{columns}
					\column{0.5\textwidth}
						\includegraphics[width=0.9\linewidth]{sbm_NMI.png}
					\column{0.5\textwidth}
						\includegraphics[width=0.9\linewidth]{sbm_AverageF1.png}
				\end{columns}
		\centering{Real-world graph:}
			\begin{columns}
					\column{0.5\textwidth}
						\includegraphics[width=0.9\linewidth]{karate_NMI.png}
					\column{0.5\textwidth}
